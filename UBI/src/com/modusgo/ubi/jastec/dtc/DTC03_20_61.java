...
public class DTC03_20_61 implements IDTCDescriptor{
	private MakerType mMakerType;
	private DTCDataDb mDTCDataDb;
	
	public DTC03_20_61(DTCDataDb dtc)	
	{
	...
	public DTCItem[] makeDTCItem() {
		...
		for(int i = 0, faultCodeIndex = 0;i < mDTCDataDb.FaultNum;i++, faultCodeIndex += 2)
		{
