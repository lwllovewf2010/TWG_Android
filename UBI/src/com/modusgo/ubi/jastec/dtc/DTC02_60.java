...
public class DTC02_60 implements IDTCDescriptor{
	private MakerType mMakerType;
	private DTCDataDb mDTCDataDb;
	
	public DTC02_60(DTCDataDb dtc)	
	{
	...
	public DTCItem[] makeDTCItem() {
		...
		for(int i = 0, faultCodeIndex = 0;i < mDTCDataDb.FaultNum;i++, faultCodeIndex += 4)
		{
