		...
		LocationListener, OnMapReadyListener
{
	...
	// TripEntry.COLUMN_NAME_VEHICLE_ID + " = " + vehicle.id, null, null, null,
	// null);
	...
	// requestParams.add(new BasicNameValuePair("start_time",
	// sdf.format(cStart.getTime())));
	// requestParams.add(new BasicNameValuePair("end_time",
	// sdf.format(cEnd.getTime())));
	// return super.doInBackground(params);
	// }
	//
	// @Override
