...
public class DiagnosticsFragment extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		// rootView.findViewById(R.id.btnSwitchDriverMenu).setBackgroundDrawable(Utils.getButtonBgStateListDrawable(prefs.getString(Constants.PREF_BR_SWITCH_DRIVER_MENU_BUTTON_COLOR,
		// Constants.SWITCH_DRIVER_BUTTON_BG_COLOR)));
		// rootView.findViewById(R.id.bottom_line).setBackgroundColor(Color.parseColor(prefs.getString(Constants.PREF_BR_LIST_HEADER_LINE_COLOR,
		...
		// }
		//
		// rootView.findViewById(R.id.btnSwitchDriverMenu).setOnClickListener(new
		// OnClickListener() {
		// @Override
...
//			btnSubmit.setBackgroundDrawable(Utils.getButtonBgStateListDrawable(prefs.getString(
//					Constants.PREF_BR_BUTTONS_BG_COLOR, Constants.BUTTON_BG_COLOR)));
//			try
//			{
//				btnSubmit.setTextColor(Color.parseColor(prefs.getString(Constants.PREF_BR_BUTTONS_TEXT_COLOR,
...
//									TranslateAnimation.RELATIVE_TO_PARENT, 0.0f, TranslateAnimation.RELATIVE_TO_PARENT,
//									0.0f, TranslateAnimation.RELATIVE_TO_PARENT, 0.0f,
